	...
	<div class="box-header">
		<h3 class="box-title">
			<button type="button" class="btn btn-block btn-primary"
				onclick="window.location='${pageContext.request.contextPath}/admin/xuatban/add';">
	...
	<div class="box-body">
						...
						<td class="text-center">
							<p>
								<a class="btn btn-warning btn-xs"
									href="${pageContext.request.contextPath}/admin/xuatban/edit?id=${m.getId()}"><i
		...
		<div class="box-footer clearfix">
			<ul class="pagination pagination-sm no-margin pull-right">
				...
				%>
				<li><a href="xuatban?currentpage=<%=i%>"
					style="background-color: #ddd" id="currentPage"><%=i + 1%></a></li>
				<%
					} else {
				%>
				<li><a href="xuatban?currentpage=<%=i%>"><%=i + 1%></a></li>
				<%
					}
					}
				%>
...
<script type="text/javascript">
	...
	function deleteItem(id){
		$.get("${pageContext.request.contextPath}/admin/xuatban/deleteItem?id="+id, function(data, status){
	        if(data==='true'){
	        	alert('Xóa thành công');
	        	window.location='${pageContext.request.contextPath}/admin/xuatban';
	        }
	    });
	}
	...
	function search(){
		var searchKey = $('#searchKey').val();
 		var url = "${pageContext.request.contextPath}/admin/xuatban?currentpage=0&searchKey="+searchKey;
 		window.location = url;
	}
</script>