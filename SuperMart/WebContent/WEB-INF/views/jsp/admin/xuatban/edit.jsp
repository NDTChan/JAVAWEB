...
<div class="row" ng-app="xuatBanApp" ng-controller="xuatBanEditCtrl">
							...
							<div class="form-group">
								...
								<div class="md-4-style-input">
									<div class="input-group">
										<ui-select allow-clear theme="bootstrap" name="MaKhachHang"
											ng-required="true" ng-model="target.MaKhachHang"
											on-select="target.MaKhachHang = $model"> <ui-select-match
											placeholder="-Chọn khách hàng">{{$select.selected.MaKhachHang}}
										- {{$select.selected.TenKhachHang}}</ui-select-match> <ui-select-choices
											repeat="item.MaKhachHang as item in lstKhachHang | filter: $select.search">
										<span
											ng-bind-html="(item.MaKhachHang + ' - ' + item.TenKhachHang) | highlight: $select.search"></span>
										</ui-select-choices> </ui-select>
										<span class="input-group-btn">
											<button type="button" ng-click="target.MaKhachHang = null"
									...
									<span style="color: red"
										ng-show="_form.MaKhachHang.$dirty && _form.MaKhachHang.$invalid">
										<span ng-show="_form.MaKhachHang.$error.required">Không
											được để trống</span>
									</span>
								</div>
							</div>
	...
	<script
		src="${pageContext.request.contextPath}/resources/Script/xuatBanController.js"></script>
</div>