...
<h2>Sửa nhóm vật tư</h2>
<div class="box">
	<c:if test="${error =='true'}" >
		<span style="color:red"> Xảy ra lỗi khi sửa. Vui lòng kiểm tra lại !</span>
		<div class="row">  </div>
	</c:if> 
	<form id="addForm" method="get" action="${pageContext.request.contextPath}/admin/nhomvattu/form" >
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-10">
					<div class="form-group">
						<label>Tên nhóm vật tư</label><span style="color: red"> (*)</span>
			...
			<div class="row">
				<div class="col-md-10">
					<div class="form-group">
						<label>Mã Loai vật tư</label><span style="color: red"> (*)</span>
