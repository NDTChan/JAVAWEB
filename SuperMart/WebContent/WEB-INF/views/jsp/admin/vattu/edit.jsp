...
<div class="box">
	<c:if test="${error =='true'}">
		<span style="color: red"> Xảy ra lỗi khi sửa. Vui lòng kiểm
			tra lại !</span>
		<div class="row"></div>
	</c:if>
	<form:form method="POST" name="form"
		action="${pageContext.request.contextPath}/admin/vattu/editAction" modelAttribute="vattu">
		<input type="hidden" class="form-control" value="${operation }"
			name="Operation" maxlength="255">
		<form:input path="Id" id="Id" type="hidden" name="Id" 
...
<script>
	$(function(){
		var image = $('#Anh').val();
		var strHtml = "<img src='${pageContext.request.contextPath}/"+image+"' width=200px height=200px>";
