...
<%@page import="com.supermart.models.NhaCungCap" %>
	...
	<div class="box-body">
		...
		<div class="box-footer clearfix">
			<ul class="pagination pagination-sm no-margin pull-right">
				<% PagingVm<NhaCungCap> result = null;
					result = (PagingVm<NhaCungCap>)request.getAttribute("result");
					for(int i = 0; i < result.getTotal(); i++) { 
						if(i == result.getCurrentPage()){%>
							<li><a href="nhacungcap?currentpage=<%= i%>"  style="background-color: #ddd" id="currentPage"><%= i+1 %></a></li>
						<%}else{ %>
							<li><a href="nhacungcap?currentpage=<%= i%>"><%= i+1 %></a></li>
					<%}} %>
			</ul>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function search(){
		var searchKey = $('#searchKey').val();
 		var url = "${pageContext.request.contextPath}/admin/nhacungcap?currentpage=0&searchKey="+searchKey;
 		window.location = url;
	}
</script>
