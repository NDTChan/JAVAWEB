							...
							<ul class="thumbnails">
									...
									<div class="product-box">
										...
										<p>
											<a href="product_detail.html"><img
												src="${pageContext.request.contextPath}/resources/themes/images/cloth/bootstrap-women-ware2.jpg"
												alt="" /></a>
										</p>
								...
								<li class="span3">
									<div class="product-box">
										<p>
											<a href="product_detail.html"><img
												src="${pageContext.request.contextPath}/resources/themes/images/cloth/bootstrap-women-ware1.jpg"
												alt="" /></a>
										</p>
								...
								<li class="span3">
									<div class="product-box">
										<p>
											<a href="product_detail.html"><img
												src="${pageContext.request.contextPath}/resources/themes/images/cloth/bootstrap-women-ware6.jpg"
												alt="" /></a>
										</p>
								...
								<li class="span3">
									<div class="product-box">
										<p>
											<a href="product_detail.html"><img
												src="${pageContext.request.contextPath}/resources/themes/images/cloth/bootstrap-women-ware5.jpg"
												alt="" /></a>
										</p>
							...
							<ul class="thumbnails">
								<li class="span3">
									<div class="product-box">
										<p>
											<a href="product_detail.html"><img
												src="${pageContext.request.contextPath}/resources/themes/images/cloth/bootstrap-women-ware4.jpg"
												alt="" /></a>
										</p>
								...
								<li class="span3">
									<div class="product-box">
										<p>
											<a href="product_detail.html"><img
												src="${pageContext.request.contextPath}/resources/themes/images/cloth/bootstrap-women-ware3.jpg"
												alt="" /></a>
										</p>
										<a href="product_detail.html" class="title">Ut wisi enim
											ad</a><br /> <a href="products.html" class="category">Commodo
