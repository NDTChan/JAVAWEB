...
app.controller('nhapMuaEditCtrl', function ($scope, $http, $uibModal, $location, $window) {
    $scope.target = {
        Details: []
    };
    $scope.TongSoLuong = 0;
    ...
    $scope.target.id = document.getElementById("id").value;
    var url = "/SuperMart/admin/nhapmua/getItemById?id="+$scope.target.id;
